...
const QuizSkillModel = require("../../models/QuizSkillModel.ts").default;
const UserRatingModel = require("../../models/UserRatingModel.ts").default;
const QuestionTypeModel = require("../../models/QuestionTypeModel.ts").default;
