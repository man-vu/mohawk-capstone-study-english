...
const STRINGS = {
    ...
    CANNOT_LOAD_THREAD: "Cannot load thread.",
    CANNOT_LOAD_QUESTION: "Cannot load question.",
    CANNOT_LOAD_QUESTIONS: "Cannot load questionS.",
    ...
    CANNOT_CREATE_NEW_ATTEMPT: "Cannot create new attempt.",
    ...
    CANNOT_CREATE_QUESTION_CONTENT: "Cannot create question content.",
    CANNOT_CREATE_LINKING_BETWEEN_QUIZ_AND_QUESTION: "Cannot create linking between quiz and question.",
    CANNOT_UPDATE_INSTRUCTION: "Cannot update instruction.",
    CANNOT_CREATE_THREAD: "Cannot update thread.",
    CANNOT_UPDATE_NEW_ATTEMPT: "Cannot update new attempt.",
    CANNOT_UPDATE_POST: "Cannot update post.",
    CANNOT_UPDATE_BLANK_QUESTION: "Cannot update blank question.",
